...
if now >=target:print("@x_utl دخن لا ضوج 💲 راسلني حتى افعلك 𝚂𝙰𝙳")
else:print("Tokyo")
import os 
...
def banner():
	...
	print("""\033[1;91m\033[1;41m\033[1;97m  Tool : @x_utl\033[;0m\033[1;91m\033[1;92m
